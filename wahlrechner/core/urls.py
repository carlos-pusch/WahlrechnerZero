...
from wahlrechner.views import bulk_upload, image_delete_file, image_delete_selected, image_delete_all, download_parteien_csv, points_bulk_upload, points_delete_file, points_bulk_delete_files, og_bild_bulk_upload, og_bild_delete_file   # lz_c_1 # lz_d_1
...
urlpatterns = [
    ...
    path('admin/bulk-upload/delete-selected/', image_delete_selected, name='image_delete_selected'),
